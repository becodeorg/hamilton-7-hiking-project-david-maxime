...
<body>
    <header>
        ...
        <?php if (!empty($_SESSION['user']) && $_SESSION['user']['isAdmin'] != 1) : ?>
            ...
            <br>
            <a href="/addHike"><span class="max-w-sm m-2 bg-slate-200 border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">Add a new hike!</span></a>
            <a href="/myhikes"><span class="max-w-sm m-2 bg-slate-200 border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">Manage my hikes</span></a>
            <a href="/myprofile"><span class="max-w-sm m-2 bg-slate-200 border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">See my profile</span></a>
        <?php endif; ?>
        <?php if (!empty($_SESSION['user']) && $_SESSION['user']['isAdmin'] === 1) : ?>
